...
const signup: NextPage = () => {
    ...
    return (
        <AuthFormLayout>
            ...
            >
                <h3 className="text-2xl font-bold mb-2">Inscrivez vous</h3>
                <p className="mb-4 text-base">
                    <span className="text-granite">Déja un compte ?&ensp;</span>
                ...
                >
                    ...
                    <span className="">Inscription avec google</span>
                </button>
                ...
                <BaseFormInput
                    ...
                    fieldPlaceholder="Retape your password"
                    register={register}
                />
                <button
                    type="submit"
